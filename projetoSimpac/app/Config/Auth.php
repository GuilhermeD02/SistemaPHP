...
class Auth extends ShieldAuth
{
    ...
    public function loginRedirect(): string
    {
       ...
       if (auth()->user()->inGroup('admin')){
        ...
        $url = auth()->user()->inGroup('user') ? '/user': setting('Auth.redirects')['login'];}
    ...
    public function registerRedirect(): string
    {
        ...
        if (auth()->user()->inGroup('admin')){
            ...
            $url = auth()->user()->inGroup('user') ? '/user': setting('Auth.redirects')['register'];}
    ...
    public function groupDeniedRedirect(): string
    {
       ...
       if (auth()->user()->inGroup('admin')){
        ...
        $url = auth()->user()->inGroup('user') ? '/user': setting('Auth.redirects')['group_denied'];}
