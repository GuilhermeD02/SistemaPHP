    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="<?= base_url("/index.php/user")?>"><span class="sronly">Página Inicial</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url("/index.php/user/inserir")?>">Inserir</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="text-center main-text">
                <h1>Bem-vindo ao Sistema de Cadastro de Artigos - Projetos Simpac ALUNO</h1>
